...
**Canopy Protector** {4}{G}
Creature - Treefolk
Reach
Whenever a land you control with a growth counter on it becomes the target of a spell or ability an opponent controls, you may create a 1/1 green Saproling creature token.
4/4

**Verdant Awakening** {X}{G}{G}
Sorcery
Search your library for up to X land cards and put them onto the battlefield tapped with a growth counter on them. Then shuffle your library.

format as a markdown table (PT/Cost not always needed) and add a Category (like Ramp/Draw etc...):

| Card Name | Cost | Type | Text | P/T | Category |
| ---- | ---- | ---- | ---- | ---- | ---- |
| Farmer | {1}{G} | Creature - Human | {T}, Tap an untapped land you control: Put a growth counter on that land. | 1/1 | Ramp |
| Harvest | {2}{G} | Sorcery | Remove all growth counters from target land you control. For each counter removed this way, create a Food token. |  | Token Generation |
| Fertile Fields |  | Land | Fertile Fields enters the battlefield with a growth counter on it. {T}: Add {G} to your mana pool. |  | Ramp |
| Bountiful Harvest | {3}{G} | Enchantment | At the beginning of your upkeep, for each land you control with a growth counter on it, create a Food token. |  | Token Generation |
| Crop Dusting | {1}{G} | Sorcery | Put a growth counter on each land you control. |  | Ramp |
| Seed Sower | {3}{G} | Creature - Elf Druid | {T}, Put a land card from your hand onto the battlefield tapped with a growth counter on it. | 2/2 | Ramp |
| Irrigation System |  | Land | Irrigation System enters the battlefield tapped with a water counter on it. {T}: Add {G} to your mana pool. If you control a land with a growth counter, add {G}{G} instead. |  | Ramp |
| Harvest Moon | {3}{G}{G} | Instant | Put a growth counter on each land you control. You gain 1 life for each land with a growth counter on it. |  | Instant |
| Farmhand | {1}{G} | Creature - Human | {T}: Put a growth counter on target land. | 1/1 | Ramp |
| Farmer's Market | {2}{G}{G} | Enchantment | At the beginning of your upkeep, you may sacrifice a Food. If you do, draw a card. |  | Draw |
| Compost Heap | {2}{G} | Enchantment | Whenever one or more growth counters are put on a land you control, gain 1 life. |  | Lifegain |
| Card Name | Cost | Type | Text | P/T | Category |
| Organic Growth | {1}{G} | Enchantment | Creatures you control get +1/+1 for each land you control with a growth counter on it. |  | Buff |
| Gardener | {3}{G} | Creature - Human | {T}: Move a growth counter from one land you control to another target land you control. | 2/2 | Utility |
| Plow | {2} | Artifact | {T}, Remove a growth counter from a land you control: Add one mana of any color to your mana pool. |  | Ramp |
| Field Worker | {1}{G} | Creature - Human | {T}: Put a growth counter on target land. If that land is tapped, untap it. | 1/1 | Ramp/Utility |
| Pesticide Spray | {1}{G} | Instant | Choose one — • Remove all pest counters from lands you control. • Put a growth counter on up to two target lands. |  | Instant/Utility |
| Tractor | {4} | Artifact | {2}, {T}, Remove a growth counter from a land you control: Untap up to two lands. |  | Utility |
| Greenhouse |  | Land | Greenhouse enters the battlefield tapped with a growth counter on it. {T}: Add {G} to your mana pool. |  | Ramp |
| Plant Whisperer | {2}{G} | Creature - Elf Druid | {T}: Create a 1/1 green Saproling creature token for each land you control with a growth counter on it. | 1/1 | Token Generation |
| Seedling |  | Land | Seedling enters the battlefield tapped with a growth counter on it. {T}: Add {G} to your mana pool. |  | Ramp |
| Crop Circle |  | Land | Crop Circle enters the battlefield tapped with a growth counter on it. {T}: Add {G} to your mana pool, or {G}{G} if you control three or more lands with growth counters. |  | Ramp |
| Orchard Keeper | {3}{G} | Creature - Elf Druid | {T}: Double the number of growth counters on target land. | 2/2 | Utility |
| Harvest Festival | {3}{G}{G} | Sorcery | Create a Food token for each land you control with a growth counter. Gain life equal to the number of Food tokens created this way. |  | Token Generation/Lifegain |
| Fruit Bat | {2}{G} | Creature - Bat | Flying {1}{G}, {T}: Put a growth counter on target land. | 2/2 | Ramp/Flying |
| Weed Killer | {1}{G} | Instant | Remove all weed counters from lands you control. For each weed counter removed this way, put a growth counter on that land. |  | Instant/Utility |
| FertilizerSpread | {2}{G} | Sorcery | Put two growth counters on up to one target land. If that land is controlled by an opponent, they draw a card. |  | Ramp/Draw |
